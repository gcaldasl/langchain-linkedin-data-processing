...
def scrape_linkedin_profile(linkedin_profile_url: str, mock: bool = False) -> str:
  ...
  data = {
    k: v for k, v in data.items() if v not in ([], "", None) and k not in ["certifications"]
  }
...
if __name__ == "__main__":
  print(scrape_linkedin_profile(linkedin_profile_url="https://www.linkedin.com/in/gcaldasl/", mock=True))